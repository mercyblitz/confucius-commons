...
@XmlType(name = "user-data-constraintType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "description",
    "transportGuarantee"
})
public class UserDataConstraintType {
    ...
    @XmlElement(name = "transport-guarantee", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
