...
@XmlType(name = "security-constraintType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "displayName",
...
public class SecurityConstraintType {
    ...
    @XmlElement(name = "web-resource-collection", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
    protected List<WebResourceCollectionType> webResourceCollection;
    @XmlElement(name = "auth-constraint", namespace = "http://java.sun.com/xml/ns/j2ee")
    protected AuthConstraintType authConstraint;
    @XmlElement(name = "user-data-constraint", namespace = "http://java.sun.com/xml/ns/j2ee")
