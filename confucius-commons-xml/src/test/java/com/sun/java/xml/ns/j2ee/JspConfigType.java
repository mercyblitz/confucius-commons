...
@XmlType(name = "jsp-configType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "taglib",
    "jspPropertyGroup"
})
public class JspConfigType {
    ...
    @XmlElement(name = "jsp-property-group", namespace = "http://java.sun.com/xml/ns/j2ee")
