...
@XmlType(name = "listenerType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "description",
    "displayName",
    "icon",
    "listenerClass"
...
public class ListenerType {
    ...
    @XmlElement(name = "listener-class", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
