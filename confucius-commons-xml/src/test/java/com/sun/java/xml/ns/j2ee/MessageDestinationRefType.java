...
@XmlType(name = "message-destination-refType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "description",
...
public class MessageDestinationRefType {
    ...
    @XmlElement(name = "message-destination-ref-name", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
    protected JndiNameType messageDestinationRefName;
    @XmlElement(name = "message-destination-type", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
    protected MessageDestinationTypeType messageDestinationType;
    @XmlElement(name = "message-destination-usage", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
    protected MessageDestinationUsageType messageDestinationUsage;
    @XmlElement(name = "message-destination-link", namespace = "http://java.sun.com/xml/ns/j2ee")
