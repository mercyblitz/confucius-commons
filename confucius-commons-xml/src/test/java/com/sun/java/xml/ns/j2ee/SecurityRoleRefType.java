...
@XmlType(name = "security-role-refType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "description",
    "roleName",
    "roleLink"
})
public class SecurityRoleRefType {
    ...
    @XmlElement(name = "role-name", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
    protected RoleNameType roleName;
    @XmlElement(name = "role-link", namespace = "http://java.sun.com/xml/ns/j2ee")
