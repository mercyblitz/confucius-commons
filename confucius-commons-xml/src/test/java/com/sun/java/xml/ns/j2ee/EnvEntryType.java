...
@XmlType(name = "env-entryType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "description",
    "envEntryName",
    "envEntryType",
    "envEntryValue"
...
public class EnvEntryType {
    ...
    @XmlElement(name = "env-entry-name", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
    protected JndiNameType envEntryName;
    @XmlElement(name = "env-entry-type", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
    protected EnvEntryTypeValuesType envEntryType;
    @XmlElement(name = "env-entry-value", namespace = "http://java.sun.com/xml/ns/j2ee")
