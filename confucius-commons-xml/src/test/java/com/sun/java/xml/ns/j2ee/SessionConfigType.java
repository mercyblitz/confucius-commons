...
@XmlType(name = "session-configType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "sessionTimeout"
})
public class SessionConfigType {

    @XmlElement(name = "session-timeout", namespace = "http://java.sun.com/xml/ns/j2ee")
