...
@XmlType(name = "filter-mappingType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "filterName",
    "urlPattern",
    "servletName",
    "dispatcher"
...
public class FilterMappingType {
    ...
    @XmlElement(name = "url-pattern", namespace = "http://java.sun.com/xml/ns/j2ee")
    protected UrlPatternType urlPattern;
    @XmlElement(name = "servlet-name", namespace = "http://java.sun.com/xml/ns/j2ee")
