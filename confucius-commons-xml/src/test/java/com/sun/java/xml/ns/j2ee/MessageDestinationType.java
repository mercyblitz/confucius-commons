...
@XmlType(name = "message-destinationType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "description",
    "displayName",
    "icon",
...
public class MessageDestinationType {
    ...
    @XmlElement(name = "message-destination-name", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
