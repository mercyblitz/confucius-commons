...
@XmlType(name = "locale-encoding-mapping-listType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "localeEncodingMapping"
})
public class LocaleEncodingMappingListType {

    @XmlElement(name = "locale-encoding-mapping", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
