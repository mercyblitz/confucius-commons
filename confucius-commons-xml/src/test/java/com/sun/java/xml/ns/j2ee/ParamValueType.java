...
@XmlType(name = "param-valueType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "description",
    "paramName",
    "paramValue"
})
public class ParamValueType {
    ...
    @XmlElement(name = "param-name", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
    protected String paramName;
    @XmlElement(name = "param-value", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
