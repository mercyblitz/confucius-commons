...
@XmlType(name = "jsp-property-groupType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "description",
    "displayName",
    "icon",
    "urlPattern",
...
public class JspPropertyGroupType {
    ...
    @XmlElement(name = "url-pattern", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
    protected List<UrlPatternType> urlPattern;
    @XmlElement(name = "el-ignored", namespace = "http://java.sun.com/xml/ns/j2ee")
    protected TrueFalseType elIgnored;
    @XmlElement(name = "page-encoding", namespace = "http://java.sun.com/xml/ns/j2ee")
    protected String pageEncoding;
    @XmlElement(name = "scripting-invalid", namespace = "http://java.sun.com/xml/ns/j2ee")
    protected TrueFalseType scriptingInvalid;
    @XmlElement(name = "is-xml", namespace = "http://java.sun.com/xml/ns/j2ee")
    protected TrueFalseType isXml;
    @XmlElement(name = "include-prelude", namespace = "http://java.sun.com/xml/ns/j2ee")
    protected List<PathType> includePrelude;
    @XmlElement(name = "include-coda", namespace = "http://java.sun.com/xml/ns/j2ee")
