...
@XmlType(name = "resource-env-refType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "description",
    "resourceEnvRefName",
    "resourceEnvRefType"
})
public class ResourceEnvRefType {
    ...
    @XmlElement(name = "resource-env-ref-name", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
    protected JndiNameType resourceEnvRefName;
    @XmlElement(name = "resource-env-ref-type", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
