...
@XmlType(name = "service-ref_handlerType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "description",
    "displayName",
    "icon",
    "handlerName",
...
public class ServiceRefHandlerType {
    ...
    @XmlElement(name = "handler-name", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
    protected String handlerName;
    @XmlElement(name = "handler-class", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
    ...
    @XmlElement(name = "soap-header", namespace = "http://java.sun.com/xml/ns/j2ee")
    protected List<XsdQNameType> soapHeader;
    @XmlElement(name = "soap-role", namespace = "http://java.sun.com/xml/ns/j2ee")
    protected List<String> soapRole;
    @XmlElement(name = "port-name", namespace = "http://java.sun.com/xml/ns/j2ee")
