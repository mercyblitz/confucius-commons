...
@XmlType(name = "mime-mappingType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "extension",
    "mimeType"
})
public class MimeMappingType {
    ...
    @XmlElement(name = "mime-type", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
