...
@XmlType(name = "port-component-refType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "serviceEndpointInterface",
    "portComponentLink"
})
public class PortComponentRefType {

    @XmlElement(name = "service-endpoint-interface", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
    protected FullyQualifiedClassType serviceEndpointInterface;
    @XmlElement(name = "port-component-link", namespace = "http://java.sun.com/xml/ns/j2ee")
