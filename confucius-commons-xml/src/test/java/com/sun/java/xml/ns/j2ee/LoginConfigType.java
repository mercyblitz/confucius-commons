...
@XmlType(name = "login-configType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "authMethod",
    "realmName",
    "formLoginConfig"
})
public class LoginConfigType {
    ...
    @XmlElement(name = "auth-method", namespace = "http://java.sun.com/xml/ns/j2ee")
    protected AuthMethodType authMethod;
    @XmlElement(name = "realm-name", namespace = "http://java.sun.com/xml/ns/j2ee")
    protected String realmName;
    @XmlElement(name = "form-login-config", namespace = "http://java.sun.com/xml/ns/j2ee")
