...
@XmlType(name = "servletType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "description",
    "displayName",
    "icon",
    "servletName",
...
public class ServletType {
    ...
    @XmlElement(name = "display-name", namespace = "http://java.sun.com/xml/ns/j2ee")
    protected List<DisplayNameType> displayName;
    @XmlElement(namespace = "http://java.sun.com/xml/ns/j2ee")
    protected List<IconType> icon;
    @XmlElement(name = "servlet-name", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
    protected ServletNameType servletName;
    @XmlElement(name = "servlet-class", namespace = "http://java.sun.com/xml/ns/j2ee")
    protected FullyQualifiedClassType servletClass;
    @XmlElement(name = "jsp-file", namespace = "http://java.sun.com/xml/ns/j2ee")
    protected JspFileType jspFile;
    @XmlElement(name = "init-param", namespace = "http://java.sun.com/xml/ns/j2ee")
    protected List<ParamValueType> initParam;
    @XmlElement(name = "load-on-startup", namespace = "http://java.sun.com/xml/ns/j2ee")
    protected XsdIntegerType loadOnStartup;
    @XmlElement(name = "run-as", namespace = "http://java.sun.com/xml/ns/j2ee")
    protected RunAsType runAs;
    @XmlElement(name = "security-role-ref", namespace = "http://java.sun.com/xml/ns/j2ee")
