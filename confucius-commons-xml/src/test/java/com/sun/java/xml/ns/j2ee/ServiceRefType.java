...
@XmlType(name = "service-refType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "description",
    "displayName",
    "icon",
    "serviceRefName",
...
public class ServiceRefType {
    ...
    @XmlElement(name = "service-ref-name", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
    protected JndiNameType serviceRefName;
    @XmlElement(name = "service-interface", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
    protected FullyQualifiedClassType serviceInterface;
    @XmlElement(name = "wsdl-file", namespace = "http://java.sun.com/xml/ns/j2ee")
    protected XsdAnyURIType wsdlFile;
    @XmlElement(name = "jaxrpc-mapping-file", namespace = "http://java.sun.com/xml/ns/j2ee")
    protected PathType jaxrpcMappingFile;
    @XmlElement(name = "service-qname", namespace = "http://java.sun.com/xml/ns/j2ee")
    protected XsdQNameType serviceQname;
    @XmlElement(name = "port-component-ref", namespace = "http://java.sun.com/xml/ns/j2ee")
