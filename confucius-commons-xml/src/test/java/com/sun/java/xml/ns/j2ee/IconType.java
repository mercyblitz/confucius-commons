...
@XmlType(name = "iconType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "smallIcon",
    "largeIcon"
})
public class IconType {

    @XmlElement(name = "small-icon", namespace = "http://java.sun.com/xml/ns/j2ee")
    protected PathType smallIcon;
    @XmlElement(name = "large-icon", namespace = "http://java.sun.com/xml/ns/j2ee")
