...
@XmlType(name = "error-pageType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "errorCode",
    "exceptionType",
    "location"
})
public class ErrorPageType {
    ...
    @XmlElement(name = "error-code", namespace = "http://java.sun.com/xml/ns/j2ee")
    protected ErrorCodeType errorCode;
    @XmlElement(name = "exception-type", namespace = "http://java.sun.com/xml/ns/j2ee")
