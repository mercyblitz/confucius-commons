...
@XmlType(name = "form-login-configType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "formLoginPage",
    "formErrorPage"
})
public class FormLoginConfigType {

    @XmlElement(name = "form-login-page", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
    protected WarPathType formLoginPage;
    @XmlElement(name = "form-error-page", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
