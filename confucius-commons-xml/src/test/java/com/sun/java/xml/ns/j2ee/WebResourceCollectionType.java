...
@XmlType(name = "web-resource-collectionType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "webResourceName",
    "description",
    "urlPattern",
    "httpMethod"
...
public class WebResourceCollectionType {
    ...
    @XmlElement(name = "web-resource-name", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
    ...
    @XmlElement(name = "http-method", namespace = "http://java.sun.com/xml/ns/j2ee")
