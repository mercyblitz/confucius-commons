...
@XmlType(name = "welcome-file-listType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "welcomeFile"
})
public class WelcomeFileListType {

    @XmlElement(name = "welcome-file", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
