...
@XmlType(name = "filterType", namespace = "http://java.sun.com/xml/ns/j2ee", propOrder = {
    "description",
    "displayName",
    "icon",
    "filterName",
...
public class FilterType {
    ...
    @XmlElement(name = "filter-name", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
    protected FilterNameType filterName;
    @XmlElement(name = "filter-class", namespace = "http://java.sun.com/xml/ns/j2ee", required = true)
